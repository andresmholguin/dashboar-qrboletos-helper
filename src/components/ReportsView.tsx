                      ...
                      <div className="p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        <div className="space-y-1.5 flex-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {ev.meta?.espectaculo && (
                              <span className="text-[10px] bg-blue-100 text-blue-900 border-blue-300 dark:bg-blue-500/15 dark:text-blue-300 dark:border-blue-500/30 border px-2 py-0.5 rounded font-mono font-bold">
                                {ev.meta.espectaculo}
                              </span>
                            )}
                            {ev.meta?.pulep && (
                              <span className="text-[10px] bg-slate-200 text-slate-800 border-slate-300 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 border px-2 py-0.5 rounded font-mono font-semibold">
                                PULEP: {ev.meta.pulep}
                              </span>
                            )}
                            {/* Badge de Entrega a Empresario */}
                            {tieneEmpresario && (
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2.5 flex-wrap">
                    ...
                    {selectedEvent.meta?.espectaculo && (
                      <span className="text-xs bg-blue-100 text-blue-900 border-blue-300 dark:bg-blue-500/15 dark:text-blue-300 dark:border-blue-500/30 border px-2.5 py-0.5 rounded-md font-mono font-bold">
                        {selectedEvent.meta.espectaculo}
                      </span>
                    )}
                    {selectedEvent.meta?.pulep && (
                      <span className="text-xs bg-slate-200 text-slate-800 border-slate-300 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 border px-2.5 py-0.5 rounded-md font-mono font-semibold">
                        PULEP: {selectedEvent.meta.pulep}
                      </span>
                    )}
